            ...
            <div className="mt-8 flex items-center gap-4">
              <div className="flex items-center rounded-full border border-border">
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-l-full text-foreground hover:bg-muted transition-colors"
                >
                ...
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-r-full text-foreground hover:bg-muted transition-colors"
                >
